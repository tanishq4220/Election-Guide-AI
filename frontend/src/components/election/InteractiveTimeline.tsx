...
const steps = [
  { id: 1, title: "Registration", icon: UserPlus, color: "from-blue-500 to-cyan-400" },
  { id: 2, title: "Verification", icon: ShieldCheck, color: "from-purple-500 to-pink-400" },
  { id: 3, title: "Voting Day", icon: Vote, color: "from-orange-500 to-red-400" },
  { id: 4, title: "Counting", icon: BarChart3, color: "from-green-500 to-emerald-400" },
];
